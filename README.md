...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/jupyterlab-urdf-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/jupyterlab-urdf-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add jupyterlab-urdf
# for installing globally
pixi global install jupyterlab-urdf
```
...
It is possible to list all of the versions of `jupyterlab-urdf` available on your platform:
...
```
pixi search jupyterlab-urdf --channel conda-forge
```
